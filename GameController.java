...
public class GameController implements ActionListener {
    ...
    public GameController(int size) {
        ...
        boardView = (new GameView(gameModel, this)).getBoardView();
        boardView.update();
    }
    ...
    private void oneStep(){
        ...
        if(isOnBorder(currentDot)) {
            ...
            Object[] options = {"Play Again",
                    "Quit"};
            int n = JOptionPane.showOptionDialog(boardView,
    ...
    private Point findDirection(){
        ...
        LinkedList<Pair<Point>> myQueue = new LinkedList<Pair<Point>>();
        ...
        for(int i = 0; i < possibleNeighbours.size() ; i++){
            ...
            myQueue.addLast(new Pair<Point>(p,p));
        ...
        while(!myQueue.isEmpty()){
            Pair<Point> pointPair = myQueue.removeFirst();
            ...
            for(int i = 0; i < possibleNeighbours.size() ; i++){
                ...
                myQueue.addLast(new Pair<Point>(p,pointPair.getSecond()));
                blocked[p.getX()][p.getY()]=true;
            }
